...
%submition_tool%\itm_driver_win.exe -S %itm_ipaddress% -P 6986 -F"-itm_in_files %%i -itm_out_files  e:\%%~pi\%%~ni.pdf" -s8040 
 ...
 ) >> C:\Users\Administrator\Transforms\TestPDF2AFP_CPSI\Log\win\all_afp2pdf_itm-driver.log 2>&1
...
xcopy /y /s /d  e:\OutputTransformPDF2AFP_CPSI\win\output\out_AFP\TestFiles\PDF\*.pdf e:\OutputTransformPDF2AFP_CPSI\win\output\out_PDF\TestFiles\PDF\ >> C:\Users\Administrator\Transforms\TestPDF2AFP_CPSI\Log\win\allcopy_afp2pdf_itm-driver.log 2>&1
